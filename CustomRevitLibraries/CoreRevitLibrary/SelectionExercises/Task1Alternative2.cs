...
namespace CoreRevitLibrary.SelectionExercises
{
    ...
    class Task1Alternative2:IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            LogicalAndFilter logicalAndFilter = new LogicalAndFilter(new ElementClassFilter(typeof(FamilyInstance)), exclusionFilter);
