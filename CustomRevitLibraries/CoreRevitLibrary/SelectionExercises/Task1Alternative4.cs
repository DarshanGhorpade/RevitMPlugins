/*
 * using foreach instead of linqs
 */
...
namespace CoreRevitLibrary.SelectionExercises
{
    ...
    public class Task1Alternative4 : IExternalCommand
    {
        public Result Execute(ExternalCommandData commandData, ref string message, ElementSet elements)
        {
            ...
            // As you can see the LINQ version is much better than foreach
            ...
            var dataToVisualize = filteredInstances.Select(f => $"{f.Category.Name} - {f.ViewSpecific}");
